...
class Ennemi(Char):
	...
	def __init__(self, fenetre, canvas, x, y, couleur, nom, pv=1):
...
class Main():
	...
	def __init__(self):
		...
		self.Joueur3 = Ennemi(self.fenetre, self.canvas, 80, 520, 'LimeGreen', ('Ordi', 60, 620, 'DarkGreen'))
		self.Joueur4 = Ennemi(self.fenetre, self.canvas, 920, 520, 'DodgerBlue', ('Ordi', 980, 620, 'DarkBlue'))
